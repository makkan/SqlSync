...
public class GroovyRunner {
	 ...
	 * @throws IOException
	 */
	public void runGroovy(final File groovyFile, SqlSyncDatabaseItem sqlSyncDatabaseItem)
			throws InstantiationException, IllegalAccessException, CompilationFailedException, IOException {
